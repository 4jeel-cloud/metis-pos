...
<head>
    <meta charset="utf-8">
    <base href="<?= base_url() ?>">
    <title><?= lang('Common.software_title') . ' | ' . esc($config['company']) . ' | ' . lang('Common.powered_by') . ' ' . esc(config('App')->application_version) ?></title>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden-sm" href="<?= site_url() ?>">
                        <img src="<?= base_url('images/logo.png') ?>" alt="<?= lang('Common.software_title') ?>" style="height: 24px;">
                    </a>
                </div>
